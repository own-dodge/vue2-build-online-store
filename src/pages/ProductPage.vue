<template>
  <main class="content container" v-if="productLoading"><img src="../../public/img/preloader.gif"
          alt="Загрузка товаров"></main>
            ...
            <fieldset class="form__block">
              ...
              <ul class="colors">
                <li class="colors__item" v-for="color in colors" :key="color.id">
                  <label :for="String(color.id) + String(product.id)" class="colors__label">
                    <input class="colors__radio sr-only" type="radio" name="color"
                     :id="String(color.id) + String(product.id)" :value="color.id">
                    <span class="colors__value" :style="{backgroundColor: color.code}">
                    </span>
                  </label>
                </li>
                <!-- <li class="colors__item">
                  <label for="color-item" class="colors__label">
            ...
            <fieldset class="form__block">
              ...
              <ul class="sizes sizes--primery">
                <li class="sizes__item">
                  <label for="sizes-item" class="sizes__label">
      ...
      <div class="item__desc">
        ...
        <div class="item__content">
          ...
          <p>
            ...
            синхронизируется с датчиками по ANT+, объединяя полученную с
            них информацию. Данные отображаются на дисплее,
          ...
          <p>
            ...
            выдерживает кратковременное (до 30 минут) погружение в
